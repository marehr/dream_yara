...
python $BENCHMARK_UTIL_DIR/parse_time_log.py $TMP_DIR/yara_mapper.time > $TMP_DIR/yara_mapper.time.json
python $BENCHMARK_UTIL_DIR/parse_yara_mapper_log.py $TMP_DIR/yara_mapper.log > $TMP_DIR/yara_mapper.log.json

python $BENCHMARK_UTIL_DIR/add_benchmark_csv_entry.py \
